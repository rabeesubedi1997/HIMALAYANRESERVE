...
export const seoDefault = {
  ...
  keywords:
    "himalayan coffee, nepal coffee, world most expensive coffee, civet coffee nepal, burj khalifa coffee, kaskikot coffee, stone ground coffee",
...
export const ancestral = {
  ...
  tiers: [
    {
      label: "100g Royal Gift Box",
      price: { AED: 149, USD: 40, NPR: 5300 },
      featured: false,
    },
    {
      label: "250g Executive Master Box",
      price: { AED: 399, USD: 108, NPR: 14300 },
      featured: false,
    },
    {
      label: "1kg Barista Reserve (Bulk)",
      price: { AED: 1200, USD: 325, NPR: 43000 },
      featured: true,
    },
  ],
} as const;
...
export const civet = {
  ...
  description:
    "Harvested not by human hands, but selected by the wild, free-roaming Himalayan Civets of Kaskikot. As these creatures roam freely within our 1,700-meter forest gardens, we do not dictate production — Nature does. 100% Cruelty-Free, Forest-Sourced, and Unpredictable in Volume.",
  tasting: [
  ...
  tiers: [
    {
      label: "100g Crown Box",
      price: { AED: 999, USD: 270, NPR: 36000 },
      featured: false,
    },
    {
      label: "250g Crown Box",
      price: { AED: 1999, USD: 545, NPR: 72000 },
      featured: true,
    },
    {
      label: "1 Cup Brewed — At.mosphere Lounge",
      price: { AED: 500, USD: 136, NPR: 18000 },
      featured: false,
    },
  ],
} as const;
...
export const craft = {
  ...
  intro:
    "While modern coffee producers manipulate beans in oxygen-deprived tanks and chemical laboratories, we honor 100% pure Himalayan nature and ancestral wisdom.",
  pillars: [
    {
      title: "1,700m Himalayan Terroir",
      text: "Cultivated at the extreme ecological boundary of coffee cultivation, nourished by pure snowmelt water and mountain air. 100% pesticide-free and chemical-free.",
    },
    {
      title: "Handpicked by Master Elders",
      text: "Only 100% deep-red, perfectly ripe cherries are selected one by one by our family elders in Kaskikot.",
    },
    {
      title: "Authentic Firewood Roasting",
      text: "Slow-roasted over real firewood, imparting a signature, subtle smoky warmth that no electric machine can replicate.",
    },
    {
      title: "Ancient Stone Grinding (Jato)",
      text: "Hand-milled on traditional stone grinders (Jato), preserving natural coffee oils without heat friction.",
    },
  ],
  patience: {
    big: "10 MONTHS",
...
export type ContentShape = {
  ...
  stats: typeof stats;
  ancestral: typeof ancestral;
  civet: typeof civet;
  craft: typeof craft;
  packaging: typeof packaging;
  dubai: typeof dubai;
  press: typeof pressClaims;
  nav: typeof navDefaults;
  footer: typeof brand;
  media: typeof mediaDefaults;
};